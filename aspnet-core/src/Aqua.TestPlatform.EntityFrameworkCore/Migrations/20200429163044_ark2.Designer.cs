...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aqua.TestPlatform.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Aqua.TestPlatform.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Aqua.TestPlatform.Entities.ArkDinoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ArkDinoTypeId");

                    b.ToTable("ArkDinoEntities");
                });

            modelBuilder.Entity("Aqua.TestPlatform.Entities.ArkDinoType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("ArkDinoTypes");
                });

            modelBuilder.Entity("Aqua.TestPlatform.Entities.ArkMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Aqua.TestPlatform.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Aqua.TestPlatform.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Aqua.TestPlatform.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Aqua.TestPlatform.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Aqua.TestPlatform.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Aqua.TestPlatform.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Aqua.TestPlatform.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Aqua.TestPlatform.Entities.ArkDinoEntity", b =>
                {
                    b.HasOne("Aqua.TestPlatform.Entities.ArkDinoType", null)
                        .WithMany("ArkDinoEntities")
                        .HasForeignKey("ArkDinoTypeId");
                });

            modelBuilder.Entity("Aqua.TestPlatform.Entities.ArkDinoType", b =>
                {
                    b.HasOne("Aqua.TestPlatform.Entities.ArkMap", null)
                        .WithMany("ArkDinoTypes")
                        .HasForeignKey("ArkMapId");
                });
