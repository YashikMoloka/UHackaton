...
namespace Aqua.TestPlatform.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TestPlatformConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
