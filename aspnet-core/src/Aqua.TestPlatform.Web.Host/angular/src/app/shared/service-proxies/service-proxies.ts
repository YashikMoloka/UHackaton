...
@Injectable()
export class ArkDinoGrabberServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getScheme(): Observable<ArkDinoSchemeDto> {
        let url_ = this.baseUrl + "/api/services/app/ArkDinoGrabber/GetScheme";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetScheme(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScheme(<any>response_);
                } catch (e) {
                    return <Observable<ArkDinoSchemeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ArkDinoSchemeDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetScheme(response: HttpResponseBase): Observable<ArkDinoSchemeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ArkDinoSchemeDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ArkDinoSchemeDto>(<any>null);
    }

    /**
     * @param adminPass (optional) 
     * @return Success
     */
    refresh(adminPass: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ArkDinoGrabber/Refresh?";
        if (adminPass === null)
            throw new Error("The parameter 'adminPass' cannot be null.");
        else if (adminPass !== undefined)
            url_ += "adminPass=" + encodeURIComponent("" + adminPass) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class ArkDinoEntity implements IArkDinoEntity {
    level: number;
    x: number;
    y: number;
    id: number;

    constructor(data?: IArkDinoEntity) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ArkDinoEntity {
        data = typeof data === 'object' ? data : {};
        let result = new ArkDinoEntity();
        result.init(data);
        return result;
    }
...
export interface IArkDinoEntity {
    level: number;
    x: number;
    y: number;
    id: number;
...
export class ArkDinoType implements IArkDinoType {
    name: string | undefined;
    arkDinoEntities: ArkDinoEntity[] | undefined;
    id: number;

    constructor(data?: IArkDinoType) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            if (Array.isArray(_data["arkDinoEntities"])) {
                this.arkDinoEntities = [] as any;
                for (let item of _data["arkDinoEntities"])
                    this.arkDinoEntities.push(ArkDinoEntity.fromJS(item));
            }
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): ArkDinoType {
        data = typeof data === 'object' ? data : {};
        let result = new ArkDinoType();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        if (Array.isArray(this.arkDinoEntities)) {
            data["arkDinoEntities"] = [];
            for (let item of this.arkDinoEntities)
                data["arkDinoEntities"].push(item.toJSON());
        }
        data["id"] = this.id;
        return data; 
    }
...
export interface IArkDinoType {
    name: string | undefined;
    arkDinoEntities: ArkDinoEntity[] | undefined;
    id: number;
}

export class ArkMap implements IArkMap {
    name: string | undefined;
    arkDinoTypes: ArkDinoType[] | undefined;
    id: number;

    constructor(data?: IArkMap) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            if (Array.isArray(_data["arkDinoTypes"])) {
                this.arkDinoTypes = [] as any;
                for (let item of _data["arkDinoTypes"])
                    this.arkDinoTypes.push(ArkDinoType.fromJS(item));
            }
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): ArkMap {
        data = typeof data === 'object' ? data : {};
        let result = new ArkMap();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        if (Array.isArray(this.arkDinoTypes)) {
            data["arkDinoTypes"] = [];
            for (let item of this.arkDinoTypes)
                data["arkDinoTypes"].push(item.toJSON());
        }
        data["id"] = this.id;
        return data; 
    }
...
export class ArkDinoSchemeDto implements IArkDinoSchemeDto {
    arkMaps: ArkMap[] | undefined;

    constructor(data?: IArkDinoSchemeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["arkMaps"])) {
                this.arkMaps = [] as any;
                for (let item of _data["arkMaps"])
                    this.arkMaps.push(ArkMap.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ArkDinoSchemeDto {
        data = typeof data === 'object' ? data : {};
        let result = new ArkDinoSchemeDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.arkMaps)) {
            data["arkMaps"] = [];
            for (let item of this.arkMaps)
                data["arkMaps"].push(item.toJSON());
        }
        return data; 
    }

    clone(): ArkDinoSchemeDto {
        const json = this.toJSON();
        let result = new ArkDinoSchemeDto();
        result.init(json);
        return result;
...
export interface IArkDinoSchemeDto {
    arkMaps: ArkMap[] | undefined;
}
